...
![Pathfinder session](Demo/t-rec.gif)

## Download

The current release is a pre-release: [**Pathfinder v1.0.0-beta**](https://github.com/dfir-ronin/pathfinder-dfir/releases/tag/v1.0.0-beta). Grab a static binary from the [Releases](https://github.com/dfir-ronin/pathfinder-dfir/releases) page, or pull it directly:
...
# arm64
curl -LO https://github.com/dfir-ronin/pathfinder-dfir/releases/download/v1.0.0-beta/pathfinder-linux-arm64
